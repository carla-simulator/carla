...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[osi_common_pb2.DESCRIPTOR,osi_object_pb2.DESCRIPTOR,osi_sensorspecific_pb2.DESCRIPTOR,])
...
_DETECTEDITEMHEADER.fields_by_name['tracking_id'].message_type = osi_common_pb2._IDENTIFIER
_DETECTEDITEMHEADER.fields_by_name['ground_truth_id'].message_type = osi_common_pb2._IDENTIFIER
_DETECTEDITEMHEADER.fields_by_name['measurement_state'].enum_type = _DETECTEDITEMHEADER_MEASUREMENTSTATE
_DETECTEDITEMHEADER.fields_by_name['sensor_id'].message_type = osi_common_pb2._IDENTIFIER
_DETECTEDITEMHEADER_MEASUREMENTSTATE.containing_type = _DETECTEDITEMHEADER
_DETECTEDSTATIONARYOBJECT_CANDIDATESTATIONARYOBJECT.fields_by_name['classification'].message_type = osi_object_pb2._STATIONARYOBJECT_CLASSIFICATION
...
_DETECTEDSTATIONARYOBJECT.fields_by_name['base'].message_type = osi_common_pb2._BASESTATIONARY
_DETECTEDSTATIONARYOBJECT.fields_by_name['base_rmse'].message_type = osi_common_pb2._BASESTATIONARY
_DETECTEDSTATIONARYOBJECT.fields_by_name['candidate'].message_type = _DETECTEDSTATIONARYOBJECT_CANDIDATESTATIONARYOBJECT
_DETECTEDMOVINGOBJECT_CANDIDATEMOVINGOBJECT.fields_by_name['type'].enum_type = osi_object_pb2._MOVINGOBJECT_TYPE
_DETECTEDMOVINGOBJECT_CANDIDATEMOVINGOBJECT.fields_by_name['vehicle_classification'].message_type = osi_object_pb2._MOVINGOBJECT_VEHICLECLASSIFICATION
_DETECTEDMOVINGOBJECT_CANDIDATEMOVINGOBJECT.fields_by_name['head_pose'].message_type = osi_common_pb2._ORIENTATION3D
_DETECTEDMOVINGOBJECT_CANDIDATEMOVINGOBJECT.fields_by_name['upper_body_pose'].message_type = osi_common_pb2._ORIENTATION3D
...
_DETECTEDMOVINGOBJECT.fields_by_name['base'].message_type = osi_common_pb2._BASEMOVING
_DETECTEDMOVINGOBJECT.fields_by_name['base_rmse'].message_type = osi_common_pb2._BASEMOVING
...
_DETECTEDMOVINGOBJECT.fields_by_name['radar_specifics'].message_type = osi_sensorspecific_pb2._RADARSPECIFICOBJECTDATA
_DETECTEDMOVINGOBJECT.fields_by_name['lidar_specifics'].message_type = osi_sensorspecific_pb2._LIDARSPECIFICOBJECTDATA
_DETECTEDMOVINGOBJECT.fields_by_name['camera_specifics'].message_type = osi_sensorspecific_pb2._CAMERASPECIFICOBJECTDATA
_DETECTEDMOVINGOBJECT.fields_by_name['ultrasonic_specifics'].message_type = osi_sensorspecific_pb2._ULTRASONICSPECIFICOBJECTDATA
