...
if (WIN32)
  ...
  if (HAS_MSVC_UTF8)
    carla_add_clike_compile_options(/utf-8)
  endif ()
endif ()
...
if (HAS_RTTI_FLAG)
  carla_add_clike_compile_options (${RTTI_FLAG})
endif ()
...
if (ENABLE_ALL_WARNINGS)
  if (CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      ...
      if (HAS_WALL)
        carla_add_clike_compile_options (-Wall)
      endif ()
    else ()
      check_cxx_compiler_flag(/Wall HAS_WALL)
      if (HAS_WALL)
...
macro (carla_try_suppress_cxx_warning NAME FLAG)
  ...
  if (HAS_${NAME})
    carla_add_clike_compile_options (
...
if (ENABLE_WARNINGS_TO_ERRORS)
  if (CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      ...
      if (HAS_WALL)
        carla_add_clike_compile_options (-Werror)
      endif ()
    else ()
      check_cxx_compiler_flag(/WX HAS_WALL)
      if (HAS_WALL)
        carla_add_clike_compile_options (/WX)
      endif ()
    endif ()
  else ()
    check_cxx_compiler_flag(-Werror HAS_WALL)
