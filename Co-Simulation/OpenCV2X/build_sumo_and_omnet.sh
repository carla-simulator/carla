...
cd ~/Downloads/
wget https://gateway.ipfs.io/ipns/ipfs.omnetpp.org/release/5.1.1/omnetpp-5.1.1-src-linux.tgz
tar -xzvf omnetpp-5.1.1-src-linux.tgz
...
# ----- for INET3.5 -----
cd ~/Downloads/
wget https://github.com/inet-framework/inet/releases/download/v3.5.0/inet-3.5.0-src.tgz
tar -xzvf inet-3.5.0-src.tgz
