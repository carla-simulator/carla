...
static PyCodeObject *codeobj_0655befe19defbbeca5892e4e3dd74dd;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_0655befe19defbbeca5892e4e3dd74dd = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[29], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_0655befe19defbbeca5892e4e3dd74dd;
    ...
    // Frame without reuse.
    frame_0655befe19defbbeca5892e4e3dd74dd = MAKE_MODULE_FRAME(codeobj_0655befe19defbbeca5892e4e3dd74dd, module_colorama);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_0655befe19defbbeca5892e4e3dd74dd);
    assert(Py_REFCNT(frame_0655befe19defbbeca5892e4e3dd74dd) == 2);
    ...
    }
    {
        ...
        frame_0655befe19defbbeca5892e4e3dd74dd->m_frame.f_lineno = 2;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_0655befe19defbbeca5892e4e3dd74dd->m_frame.f_lineno = 3;
    ...
    tmp_import_from_2__module = NULL;
    {
        ...
        frame_0655befe19defbbeca5892e4e3dd74dd->m_frame.f_lineno = 4;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_0655befe19defbbeca5892e4e3dd74dd);
#endif
    popFrameStack();

    assertFrameObject(frame_0655befe19defbbeca5892e4e3dd74dd);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_0655befe19defbbeca5892e4e3dd74dd, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_0655befe19defbbeca5892e4e3dd74dd->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_0655befe19defbbeca5892e4e3dd74dd, exception_lineno);
    }
