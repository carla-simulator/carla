...
class PrtStops(am.ArrayObjman):
    ...
    def _init_attributes(self):
        ...
        self.add(cm.AttrConf('time_update_man', 30.0,
                             groupnames=['parameters'],
        ...
        self.add(cm.AttrConf('timehorizon', 1200,
                             groupnames=['parameters'],
                             name='Time horizon',
    ...
    def prepare_sim(self, process):
        ...
        return [(self.time_update.get_value(), self.process_step),
                (self.time_update_man.get_value(), self.process_man),
                ]+updatedata_berth
...
class PrtVehicles(am.ArrayObjman):
    ...
    def make_vtype(self):
        self.get_scenario().demand.vtypes.add_vtype('PRT',
                                                    accel=2.5,
                                                    decel=2.5,
                                                    sigma=1.0,
                                                    length=3.5,
