...
class PrtStops(am.ArrayObjman):
    ...
    def schedule_trip_occupied(self, id_stop, id_berth, id_veh, simtime):
        ...
        if id_person_sumo_inveh is not None:
            ...
            self.parent.vehicleman.schedule_trip_occupied(id_veh, id_stop, id_stop_dest)

            self.parent.prtvehicles.schedule_trip_occupied(id_veh, self.ids_stop_to_ids_acceledge_sumo[id_stop])
    ...
    def schedule_trip_empty(self, id_stop, id_berth, id_veh, simtime):
        ...
        #id_stop_target = self.parent.vehicleman.schedule_trip_empty(id_veh, id_stop)
        self.parent.vehicleman.schedule_trip_empty(id_veh, id_stop)
        ...
        self.parent.prtvehicles.schedule_trip_empty(id_veh, self.ids_stop_to_ids_acceledge_sumo[id_stop])
        berths.states[id_berth] = BERTHSTATES['free']
        berths.ids_veh[id_berth] = -1
...
class PrtVehicles(am.ArrayObjman):
    ...
    def reschedule_trip(self, id_veh, id_edge_sumo_to):
        ...
        traci.vehicle.changeTarget(self.get_id_sumo(id_veh), id_edge_sumo_to)
...
class VehicleMan(am.ArrayObjman):
    ...
    def schedule_trip_occupied(self, id_veh, id_stop_from, id_stop_to):
        # print 'schedule_trip_occupied from',id_veh, id_stop_from, id_stop_to
        # search closest stop
    ...
    def schedule_trip_empty(self, id_veh, id_stop):
        # print 'schedule_trip_empty id_veh,id_stop',id_veh,id_stop
        # search closest stop
