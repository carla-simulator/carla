...
class Mergenodes(am.ArrayObjman):
    ...
    def _init_attributes(self):
        ...
        self.add_col(am.IdsArrayConf('ids_mergenode_in1', net.nodes,
        ...
        self.add_col(am.IdsArrayConf('ids_mergenode_in2', net.nodes,
            ...
            if id_type == id_zippertype:
                ...
                if (len(ids_edge_from) == 2) & (len(ids_edge_to) == 1):
                    ...
                    if (al1 == 2) & (al2 == 2):
                        ...
                        id_node_up1 = self.search_upstream_merge(id_edge1, edges, lanes, id_prtmode)
                        id_node_up2 = self.search_upstream_merge(id_edge2, edges, lanes, id_prtmode)
                    ...
                    if al_in == 1:
                        ...
                        id_node_up = self.search_upstream_merge(id_edge_from, edges, lanes, id_prtmode)
    ...
    def search_upstream_merge(self, id_edge_start, edges, lanes, id_prtmode):
        ...
        return edges.ids_fromnode[id_edge]
