                    ...
                    if (simtime - releasetime_queue > 15):
                        ...
                        for i in range(len(queue_alloc)):
                            ...
                            if vehicles.reached_stop_sumo(vehicles.ids_sumo[id_veh]):
                                ...
                                ind_pl_alloc = i
                                break
                        # print '      found alloc prt.%s at ind_pl_alloc %d'%(id_veh_arrived,ind_pl_alloc)
                        if id_veh_arrived > -1:
                            ...
                            # print '    with platoon length %.2fm greater %.2fm?'%(len(ids_platoon)*self.length_veh + 0.5,length_plat)
