...
class BirgilMatcher(Process):
    def __init__(self,  mapmatching, logger=None, **kwargs):
        ...
        self.dist_min = attrsman.add(cm.AttrConf('dist_min', kwargs.get('dist_min', 3.0),
                                                 ...
                                                 name='Min. dist',
                                                 unit='m',
                                                 info='Minimum distance in the calculation of the edge cost function.',
                                                 ))
    ...
    def do(self):
        ...
        for id_trip, ids_point, id_mode in zip(ids_trip, trips.ids_points[ids_trip], ids_mode):
            ...
            route, length_route, duration_gps, lengthindex, err_dist, t_match = \
                self.match_trip_birgil(id_trip, ids_point, fstar, costs[id_mode])
    ...
    def match_trip_birgil(self, id_trip,  ids_point, fstar, costs):
        print 79*'='
        ...
        for id_edge in ids_edge_initial:
            ...
            routelist.append([cost0, 0.0, length_edge, [id_edge]])
        ...
        while (ind_point < ind_point_final):  # & is_connected:
            ...
            for routeinfo in routelist:
                cost, length_partial, length_edge, ids_edge = routeinfo
                ...
                if (np.isnan(dist_point_edge)) | (dist_point_edge > self.width_buffer_max):
                    ...
                    if len(ids_edge_next) == 0:
                        ...
                        length_edge = edges.lengths[id_edge]
                        cost_edge = self._get_cost_birgil(point, id_edge, phi_point, get_dist_point_to_edge)
                    ...
                    routeinfo[:] = cost+cost_edge, length_partial, length_edge, ids_edge_new
                    ...
                    if len(ids_edge_next) > 1:
                        for id_edge in ids_edge_next[1:]:
                            ...
                            routelist_new.append([cost+cost_edge, length_partial, length_edge, ids_edge_new])
                    ...
                    if len(ids_edge) > 0:
                        ...
                        cost += self._get_cost_birgil(point, id_edge_last, phi_point, get_dist_point_to_edge)

                    routeinfo[:] = cost, length_partial, length_edge, ids_edge
        ...
        cost, length_partial, length_edge, ids_edge = routelist[0]
    ...
    def _get_cost_birgil(self, p, id_edge, phi_point, get_dist_point_to_edge):
