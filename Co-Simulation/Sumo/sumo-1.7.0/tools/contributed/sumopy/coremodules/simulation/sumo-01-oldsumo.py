...
class Sumo(CmlMixin, Process):
    def __init__(self, scenario,
        ...
        if is_export_net:
            ...
            self.ptstopsfilepath = scenario.net.ptstops.export_sumoxml()
        ...
        if is_export_rou:
            routefilepaths = scenario.demand.export_routes_xml()
    ...
    def do(self):
        ...
        if self.ptstopsfilepath is not False:
