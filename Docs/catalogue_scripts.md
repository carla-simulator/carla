...
| --generation | - | 2 | Specify vehicle model generation |
| --sync | - | Deactivated | Activate the script in synchronous mode |
| --loop | -l | Deactivated | Sets a new random destination upon reaching the previous one |
...
This script demonstrates the visualization of LIDAR point clouds generated by the CARLA LIDAR sensor 
