...
# [Cosmos Transfer](nvidia_cocmos_transfer.md)
...
Please refer to the [Cosmos Transfer documentation](nvidia_cocmos_transfer.md) for details on how to use this tool with CARLA. 