...
Enables the use of offset for the conversion. The offset will move the position of the origin of the map. If enabled, this setting overwrites part of the `proj_string` setting that defines latitude and longitude origin. As a result, the OpenDRIVE will not contain the `proj_string`. __Default is `False`__.  
...
Sets the coordinate origin in the center of the map. If enabled, this setting overwrites part of the `proj_string` setting that defines latitude and longitude origin. As a result, the OpenDRIVE will not contain the `proj_string`. __Default is `False`__.  
...
##### Setters
- <a name="carla.Osm2OdrSettings.set_osm_way_types"></a>**<font color="#7fb800">set_osm_way_types</font>**(<font color="#00a6ed">**self**</font>, <font color="#00a6ed">**way_types**=['motorway', 'motorway_link', 'trunk', 'trunk_link', 'primary', 'primary_link', 'secondary', 'secondary_link', 'tertiary', 'tertiary_link', 'unclassified', 'residential']</font>)  
Sets which Open Street Map roads will be exported to OpenDRIVE.  
    - **Parameters:**
        - `way_types` (_list(str)_) – The list of Open Street Map road types that should be exported to OpenDRIVE.  
- <a name="carla.Osm2OdrSettings.set_traffic_light_excluded_way_types"></a>**<font color="#7fb800">set_traffic_light_excluded_way_types</font>**(<font color="#00a6ed">**self**</font>, <font color="#00a6ed">**way_types**=['motorway_link', 'primary_link', 'secondary_link', 'tertiary_link']</font>)  
Sets a list of Open Street Map roads that will not generate traffic lights even if `generate_traffic_lights` is enabled. This prevents link roads or high ways from generating traffic lights.  
    - **Parameters:**
        - `way_types` (_list(str)_) – The list of Open Street Map road types that will not generate traffic lights.  
