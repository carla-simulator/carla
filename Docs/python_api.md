...
- <a name="carla.World.get_instance_tagging_style"></a>**<font color="#7fb800">get_instance_tagging_style</font>**(<font color="#00a6ed">**self**</font>)  
Returns the current style used for tagging actors.  
    - **Return:** _str_  
    - **Setter:** _[carla.World.set_instance_tagging_style](#carla.World.set_instance_tagging_style)_  
...
##### Setters
- <a name="carla.World.set_instance_tagging_style"></a>**<font color="#7fb800">set_instance_tagging_style</font>**(<font color="#00a6ed">**self**</font>, <font color="#00a6ed">**style**</font>)  
    - **Parameters:**
        - `style` (_str_) - Sets the style for tagging actors, which affects the results from [Instance segmentation camera](https://[carla.readthedocs.io](#carla.readthedocs.io)/en/latest/ref_sensors/#instance-segmentation-camera). Value can be either `actor_id` (meshes are colored by Carla's actor ID) or `internal_id` (meshes are colored by Unreal's internal ID).  __Default is `internal_id`__.  
    - **Getter:** _[carla.World.get_instance_tagging_style](#carla.World.get_instance_tagging_style)_  
    - **Note:** <font color="#8E8E8E">_Should be used after all actors are spawned. `actor_id` can match other information of the actors, e.g., bounding boxes and vehicle types.
_</font>  
