# Python API reference (0.9.6)

This reference contains all the details about the Python API as it was for __CARLA 0.9.6__.
...
Class used for controlling the skeleton of a walker. See [walker bone control](../tuto_G_control_walker_skeletons.md).  
