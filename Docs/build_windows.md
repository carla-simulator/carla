...
* [__Python3.8 x64__](https://www.python.org/downloads/) is the main scripting language in CARLA. Having a x32 or different from 3.8 version installed may cause conflict, so it is highly advisable to have it uninstalled.
