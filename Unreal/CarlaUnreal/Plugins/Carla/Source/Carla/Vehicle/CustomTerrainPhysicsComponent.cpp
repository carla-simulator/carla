    ...
    ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
  ...
  if (bDrawHeightMap)
  {
    ...
    ULineBatchComponent* LineBatcher = 
        (World ? World->GetLineBatcher(bDepthIsForeground ? UWorld::ELineBatcherType::Foreground :
        (( bPersistentLines || (LifeTime > 0.f) ) ? UWorld::ELineBatcherType::WorldPersistent : UWorld::ELineBatcherType::World)) : nullptr);
    if (!LineBatcher)
    {
