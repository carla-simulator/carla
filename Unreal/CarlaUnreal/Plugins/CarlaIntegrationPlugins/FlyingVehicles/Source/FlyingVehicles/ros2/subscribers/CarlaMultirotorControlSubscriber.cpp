...
#include "FlyingVehicles/ros2/types/CarlaMultirotorControlPubSubTypes.h"
#include "FlyingVehicles/ros2/listeners/CarlaMultirotorSubscriberListener.h"
...
namespace ros2 {
  ...
  struct CarlaMultirotorControlSubscriberImpl {
    ...
    efd::TypeSupport _type { new carla_interfaces::msg::CarlaMultirotorControlPubSubType() };
    CarlaMultirotorSubscriberListener _listener {nullptr};
    carla_interfaces::msg::CarlaMultirotorControl _event {};
