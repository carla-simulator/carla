...
class FCarlaTemplateExternalInterfaceActor : public FCarlaActor
{
public:
  ...
  static TSharedPtr<FCarlaTemplateExternalInterfaceActor> CreateInstance(FCarlaActor::IdType ActorId, 
                AActor* Actor, 
                TSharedPtr<const FActorInfo> Info, 
                carla::rpc::ActorState InState, 
                UWorld* World);
