...
if %DO_COPY_FILES%==true (
    ...
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\README.md"                      "!XCOPY_TO!PythonAPI\agents\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\requirements.txt"               "!XCOPY_TO!PythonAPI\agents\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\setup.py"                       "!XCOPY_TO!PythonAPI\agents\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\dist\*.egg"                     "!XCOPY_TO!PythonAPI\agents\dist\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\dist\*.whl"                     "!XCOPY_TO!PythonAPI\agents\dist\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\source\agents\*.py"             "!XCOPY_TO!PythonAPI\agents\source\agents\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\source\agents\navigation\*.py"  "!XCOPY_TO!PythonAPI\agents\source\agents\navigation\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\agents\source\agents\tools\*.py"       "!XCOPY_TO!PythonAPI\agents\source\agents\tools\"
    echo f | xcopy /y "!XCOPY_FROM!PythonAPI\carla\README.md"                       "!XCOPY_TO!PythonAPI\carla\"
