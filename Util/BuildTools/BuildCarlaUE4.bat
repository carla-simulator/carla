...
if %REMOVE_INTERMEDIATE% == true (
    ...
    if exist "%CARLA_FOLDER%.vs" rmdir /S /Q "%CARLA_FOLDER%.vs"
...
if %genVsSolution% == true (
    ...
    rem Build the editor as is needed to cook the Carla content
    call MsBuild.exe "%CARLA_FOLDER%CarlaUE4.sln" /m /p:configuration="Development Editor" /p:platform=Win64
    if errorlevel 1 goto error_build

    call "%UE4_ROOT%/Engine/Binaries/Win64/UE4Editor-Cmd.exe" "%CARLA_FOLDER%CarlaUE4.uproject"^
