...
// Save UE macros that <windows.h> redefines, in case a LibCarla dependency
// includes it raw (see UE's Windows/PreWindowsApi.h).
#if defined(_WIN32)
#  pragma push_macro("TEXT")
#endif

// Atomics scrubbed by enable-ue4-macros.h that asio/msgpack still use
// (see UE's Windows/AllowWindowsPlatformAtomics.h).
#if defined(_WIN32) && defined(_WINNT_) && !defined(InterlockedIncrement)
