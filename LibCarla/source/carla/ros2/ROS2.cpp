...
void ROS2::ProcessDataFromLidar(
  ...
  // The lidar returns a flat list of floats rather than structured
  // detection points. Each lidar detection consists of 4 floats:
  // x, y, z, and intensity. Divide the total number of floats
  // by 4 to get the number of lidar detections.
