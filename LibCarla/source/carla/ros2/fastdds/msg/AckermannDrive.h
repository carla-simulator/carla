...
public:
   ...
   * @param x Reference to the object ackermann_msgs::msg::AckermannDrive that will be copied.
   */
  eProsima_user_DllExport AckermannDrive(AckermannDrive&& x);
   ...
   * @param x Reference to the object ackermann_msgs::msg::AckermannDrive that will be copied.
   */
  eProsima_user_DllExport AckermannDrive& operator=(AckermannDrive&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const ackermann_msgs::msg::AckermannDrive& data,
