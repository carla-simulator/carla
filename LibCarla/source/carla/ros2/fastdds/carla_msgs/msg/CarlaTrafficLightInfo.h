...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfo that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfo(CarlaTrafficLightInfo&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfo that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfo& operator=(CarlaTrafficLightInfo&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaTrafficLightInfo& data,
