...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfoList that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList(CarlaTrafficLightInfoList&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfoList that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList& operator=(CarlaTrafficLightInfoList&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaTrafficLightInfoList& data,
