...
CarlaEgoVehicleControlPubSubType::CarlaEgoVehicleControlPubSubType()
{
    ...
    uint32_t type_size =
        ...
        static_cast<uint32_t>(CarlaEgoVehicleControl::getMaxCdrSerializedSize());
#else
...
{
    CarlaEgoVehicleControl* p_type =
            static_cast<CarlaEgoVehicleControl*>(data);
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               try
               {
                   ...
                   return static_cast<uint32_t>(calculator.calculate_serialized_size(
                               *static_cast<CarlaEgoVehicleControl*>(data), current_alignment)) +
                           4u /*encapsulation*/;
               }
               catch (eprosima::fastcdr::exception::Exception& /*exception*/)
               {
