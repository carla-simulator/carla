...
{
    // m_synchronous_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5dafbe45
    m_synchronous_mode = false;
    // m_no_rendering_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2254127a
    m_no_rendering_mode = false;
    // m_fixed_delta_seconds com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51891008
    m_fixed_delta_seconds = 0.0;
    // m_substepping com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f953efd
    m_substepping = true;
    // m_max_substep_delta_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f68f0dc
    m_max_substep_delta_time = 0.01;
    // m_max_substeps com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d2de489
    m_max_substeps = 10;
    // m_max_culling_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14bdbc74
    m_max_culling_distance = 0.0;
    // m_deterministic_ragdolls com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12591ac8
    m_deterministic_ragdolls = false;
    // m_tile_stream_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a7fe64f
    m_tile_stream_distance = 3000.0;
    // m_actor_active_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b66c0fb
    m_actor_active_distance = 2000.0;
    // m_spectator_as_ego com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e0e1046
