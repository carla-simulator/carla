...
namespace etsi_its_cam_msgs {
    namespace msg {
        ...
        HeadingConfidencePubSubType::HeadingConfidencePubSubType()
        {
            ...
            auto type_size = HeadingConfidence::getMaxCdrSerializedSize();
            type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
            m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
            m_isGetKeyDefined = HeadingConfidence::isKeyDefined();
            size_t keyLength = HeadingConfidence::getKeyMaxCdrSerializedSize() > 16 ?
                    HeadingConfidence::getKeyMaxCdrSerializedSize() : 16;
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    HeadingConfidence::getKeyMaxCdrSerializedSize());

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            p_type->serializeKey(ser);
            if (force_md5 || HeadingConfidence::getKeyMaxCdrSerializedSize() > 16)
            {
                m_md5.init();
