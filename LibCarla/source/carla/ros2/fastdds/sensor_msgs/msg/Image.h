...
public:
     ...
     * @param x Reference to the object sensor_msgs::msg::ImageT that will be copied.
     */
    eProsima_user_DllExport ImageT(
     ...
     * @param x sensor_msgs::msg::ImageT object to compare.
     */
...
#endif // _FAST_DDS_G>ENERATED_SENSOR_MSGS_MSG_IMAGE_H_
