...
public:
   ...
   */
  eProsima_user_DllExport const sensor_msgs::msg::sensor_msgs__Imu__double_array_9& linear_acceleration_covariance()
      const;
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const sensor_msgs::msg::Imu& data,
