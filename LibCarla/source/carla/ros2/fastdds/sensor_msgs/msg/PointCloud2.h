...
namespace msg {
/*!
 * @brief This class represents the structure  PointCloud2T defined by the user in the IDL file.
 * @ingroup POINTCLOUD2
 */
...
public:
   ...
   */
  eProsima_user_DllExport PointCloud2T();
   ...
   * @param x Reference to the object sensor_msgs::msg::PointCloud2T<ALLOCATOR> that will be copied.
   */
  eProsima_user_DllExport PointCloud2T(const PointCloud2T<ALLOCATOR>& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object sensor_msgs::msg::PointCloud2T<ALLOCATOR> that will be copied.
   */
  eProsima_user_DllExport PointCloud2T(PointCloud2T<ALLOCATOR>&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object sensor_msgs::msg::PointCloud2T<ALLOCATOR> that will be copied.
   */
  eProsima_user_DllExport PointCloud2T<ALLOCATOR>& operator=(const PointCloud2T<ALLOCATOR>& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object sensor_msgs::msg::PointCloud2T<ALLOCATOR> that will be copied.
   */
  eProsima_user_DllExport PointCloud2T<ALLOCATOR>& operator=(PointCloud2T<ALLOCATOR>&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x sensor_msgs::msg::PointCloud2T<ALLOCATOR> object to compare.
   */
  eProsima_user_DllExport bool operator==(const PointCloud2T<ALLOCATOR>& x) const;
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const sensor_msgs::msg::PointCloud2T<ALLOCATOR>& data,
