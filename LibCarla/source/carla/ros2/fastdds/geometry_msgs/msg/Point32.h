...
public:
   ...
   * @param x Reference to the object geometry_msgs::msg::Point32 that will be copied.
   */
  eProsima_user_DllExport Point32(Point32&& x);
   ...
   * @param x Reference to the object geometry_msgs::msg::Point32 that will be copied.
   */
  eProsima_user_DllExport Point32& operator=(Point32&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const geometry_msgs::msg::Point32& data,
