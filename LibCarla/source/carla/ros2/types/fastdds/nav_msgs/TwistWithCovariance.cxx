...
{
    // geometry_msgs::msg::Twist m_twist_value
        ...
        const TwistWithCovariance& x) const
{
    ...
    return (m_twist_value == x.m_twist_value && m_covariance == x.m_covariance);
}
        ...
        size_t current_alignment)
{
    ...
    current_alignment += geometry_msgs::msg::Twist::getCdrSerializedSize(data.twist_value(), current_alignment);
 ...
 */
void geometry_msgs::msg::TwistWithCovariance::twist_value(
        const geometry_msgs::msg::Twist& _twist_value)
{
 ...
 */
void geometry_msgs::msg::TwistWithCovariance::twist_value(
        geometry_msgs::msg::Twist&& _twist_value)
{
 ...
 */
const geometry_msgs::msg::Twist& geometry_msgs::msg::TwistWithCovariance::twist_value() const
{
 ...
 */
geometry_msgs::msg::Twist& geometry_msgs::msg::TwistWithCovariance::twist_value()
{
    return m_twist_value;
}
/*!
 ...
 */
const std::array<double, 36>& geometry_msgs::msg::TwistWithCovariance::covariance() const
{
    return m_covariance;
}
 ...
 */
std::array<double, 36>& geometry_msgs::msg::TwistWithCovariance::covariance()
{
    return m_covariance;
}
