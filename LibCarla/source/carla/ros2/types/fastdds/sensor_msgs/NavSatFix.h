    ...
    namespace msg {
        ...
        public:
            ...
            eProsima_user_DllExport void position_covariance(
                    const std::array<double, 9>& _position_covariance);
             ...
             */
            eProsima_user_DllExport void position_covariance(
                    std::array<double, 9>&& _position_covariance);
             ...
             */
            eProsima_user_DllExport const std::array<double, 9>& position_covariance() const;

            /*!
             * @brief This function returns a reference to member position_covariance
             * @return Reference to member position_covariance
             */
            eProsima_user_DllExport std::array<double, 9>& position_covariance();
            /*!
        ...
        private:
            ...
            double m_longitude;
            double m_altitude;
            std::array<double, 9> m_position_covariance;
