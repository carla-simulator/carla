 ...
 */
const std::array<double, 9>& sensor_msgs::msg::NavSatFix::position_covariance() const
{
 ...
 */
std::array<double, 9>& sensor_msgs::msg::NavSatFix::position_covariance()
{
    return m_position_covariance;
}
/*!
