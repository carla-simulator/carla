...
namespace geometry_msgs
{
    namespace msg
    {
        ...
        namespace detail {
            ...
            {
                typedef std::array<double, 36> TwistWithCovariance::* type;
        ...
        private:
            ...
            {
                return 336ULL == (detail::TwistWithCovariance_offset_of<TwistWithCovariance, detail::TwistWithCovariance_f>() + sizeof(std::array<double, 36>));
