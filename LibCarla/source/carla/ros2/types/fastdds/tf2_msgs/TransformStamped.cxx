...
geometry_msgs::msg::TransformStamped::TransformStamped()
{
    ...
    m_child_frame_id ="";
    // geometry_msgs::msg::Transform m_transform_value
        ...
        const TransformStamped& x)
{
    ...
    m_transform_value = x.m_transform_value;
}
        ...
        TransformStamped&& x) noexcept 
{
    ...
    m_transform_value = std::move(x.m_transform_value);
}
        ...
        const TransformStamped& x) const
{
    ...
    return (m_header == x.m_header && m_child_frame_id == x.m_child_frame_id && m_transform_value == x.m_transform_value);
}
        ...
        size_t current_alignment)
{
    ...
    current_alignment += geometry_msgs::msg::Transform::getCdrSerializedSize(data.transform_value(), current_alignment);
...
/*!
 * @brief This function copies the value in member transform_value
 * @param _transform_value New value to be copied in member transform_value
 */
void geometry_msgs::msg::TransformStamped::transform_value(
        const geometry_msgs::msg::Transform& _transform_value)
{
    m_transform_value = _transform_value;
}

/*!
 * @brief This function moves the value in member transform_value
 * @param _transform_value New value to be moved in member transform_value
 */
void geometry_msgs::msg::TransformStamped::transform_value(
        geometry_msgs::msg::Transform&& _transform_value)
{
    m_transform_value = std::move(_transform_value);
}

/*!
 * @brief This function returns a constant reference to member transform_value
 * @return Constant reference to member transform_value
 */
const geometry_msgs::msg::Transform& geometry_msgs::msg::TransformStamped::transform_value() const
{
    return m_transform_value;
}

/*!
 * @brief This function returns a reference to member transform_value
 * @return Reference to member transform_value
 */
geometry_msgs::msg::Transform& geometry_msgs::msg::TransformStamped::transform_value()
{
    return m_transform_value;
}
