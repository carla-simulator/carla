...
// FastDDS-generated types (current flat layout)
...
#include "carla/ros2/types/Point32.h"
#include "carla/ros2/types/Pose.h"
#include "carla/ros2/types/PoseWithCovariance.h"
#include "carla/ros2/types/Twist.h"
#include "carla/ros2/types/TwistWithCovariance.h"
#include "carla/ros2/types/Transform.h"
#include "carla/ros2/types/TransformStamped.h"
#include "carla/ros2/types/Odometry.h"
#include "carla/ros2/types/RegionOfInterest.h"
#include "carla/ros2/types/PointField.h"
#include "carla/ros2/types/NavSatStatus.h"
#include "carla/ros2/types/NavSatFix.h"
#include "carla/ros2/types/Clock.h"
#include "carla/ros2/types/Float32.h"
...
#include "carla/ros2/types/TF2Error.h"
#include "carla/ros2/types/AckermannDrive.h"
...
#include "carla/ros2/types/CarlaLineInvasion.h"
...
// ============================================================
// Conversion functions: POD msg types <-> FastDDS-generated types
// Order matters — composites call primitives.
// ============================================================
...
inline void to_fastdds(
    const msg::Quaternion& src,
...
inline void to_fastdds(
    const msg::PoseWithCovariance& src,
    geometry_msgs::msg::PoseWithCovariance& dst) {
...
inline void to_fastdds(
    const msg::TwistWithCovariance& src,
    geometry_msgs::msg::TwistWithCovariance& dst) {
  to_fastdds(src.twist, dst.twist());
  dst.covariance(src.covariance);
}

inline void from_fastdds(
    const geometry_msgs::msg::TwistWithCovariance& src,
    msg::TwistWithCovariance& dst) {
  from_fastdds(src.twist(), dst.twist);
  dst.covariance = src.covariance();
}

inline void to_fastdds(
    const msg::Transform& src,
    geometry_msgs::msg::Transform& dst) {
...
inline void to_fastdds(
    const msg::TransformStamped& src,
    geometry_msgs::msg::TransformStamped& dst) {
  to_fastdds(src.header, dst.header());
  dst.child_frame_id(src.child_frame_id);
  to_fastdds(src.transform, dst.transform());
}

inline void from_fastdds(
    const geometry_msgs::msg::TransformStamped& src,
    msg::TransformStamped& dst) {
  from_fastdds(src.header(), dst.header);
  dst.child_frame_id = src.child_frame_id();
  from_fastdds(src.transform(), dst.transform);
}

// --- Sensor primitives ---

inline void to_fastdds(
    const msg::RegionOfInterest& src,
    sensor_msgs::msg::RegionOfInterest& dst) {
...
inline void from_fastdds(
    const sensor_msgs::msg::RegionOfInterest& src,
    msg::RegionOfInterest& dst) {
  dst.x_offset = src.x_offset();
  dst.y_offset = src.y_offset();
  dst.height = src.height();
  dst.width = src.width();
...
inline void to_fastdds(
    const msg::PointField& src,
    sensor_msgs::msg::PointField& dst) {
  dst.name(src.name);
...
inline void from_fastdds(
    const sensor_msgs::msg::PointField& src,
    msg::PointField& dst) {
  dst.name = src.name();
  dst.offset = src.offset();
  dst.datatype = src.datatype();
...
inline void to_fastdds(
    const msg::NavSatStatus& src,
    sensor_msgs::msg::NavSatStatus& dst) {
  dst.status(src.status);
  dst.service(src.service);
}

inline void from_fastdds(
    const sensor_msgs::msg::NavSatStatus& src,
    msg::NavSatStatus& dst) {
  dst.status = src.status();
  dst.service = src.service();
}
...
inline void to_fastdds(const msg::Clock& src, rosgraph::msg::Clock& dst) {
  to_fastdds(src.clock, dst.clock());
}

inline void from_fastdds(const rosgraph::msg::Clock& src, msg::Clock& dst) {
  from_fastdds(src.clock(), dst.clock);
}
...
inline void to_fastdds(const msg::String& src, std_msgs::msg::String& dst) {
  dst.data(src.data);
}

inline void from_fastdds(const std_msgs::msg::String& src, msg::String& dst) {
  dst.data = src.data();
}
...
inline void to_fastdds(
    const msg::NavSatFix& src,
    sensor_msgs::msg::NavSatFix& dst) {
  to_fastdds(src.header, dst.header());
...
inline void from_fastdds(
    const sensor_msgs::msg::NavSatFix& src,
    msg::NavSatFix& dst) {
  from_fastdds(src.header(), dst.header);
...
// Image: const-ref overload (copies data vector)
...
// Image: non-const overload (moves data vector)
...
inline void to_fastdds(
    const msg::CameraInfo& src,
    sensor_msgs::msg::CameraInfo& dst) {
  to_fastdds(src.header, dst.header());
  dst.height(src.height);
  dst.width(src.width);
...
// PointCloud2: const-ref overload (copies data vector)
inline void to_fastdds(
    const msg::PointCloud2& src,
...
// PointCloud2: non-const overload (moves data vector)
inline void to_fastdds(
    msg::PointCloud2& src,
    sensor_msgs::msg::PointCloud2& dst) {
  to_fastdds(src.header, dst.header());
...
inline void to_fastdds(
    const msg::AckermannDrive& src,
    ackermann_msgs::msg::AckermannDrive& dst) {
...
inline void from_fastdds(
    const ackermann_msgs::msg::AckermannDrive& src,
    msg::AckermannDrive& dst) {
  dst.steering_angle = src.steering_angle();
  dst.steering_angle_velocity = src.steering_angle_velocity();
  dst.speed = src.speed();
  dst.acceleration = src.acceleration();
...
inline void to_fastdds(
    const msg::AckermannDriveStamped& src,
    ackermann_msgs::msg::AckermannDriveStamped& dst) {
  to_fastdds(src.header, dst.header());
  to_fastdds(src.drive, dst.drive());
}

inline void from_fastdds(
    const ackermann_msgs::msg::AckermannDriveStamped& src,
    msg::AckermannDriveStamped& dst) {
  from_fastdds(src.header(), dst.header);
...
inline void to_fastdds(
    const msg::CarlaCollisionEvent& src,
    carla_msgs::msg::CarlaCollisionEvent& dst) {
  to_fastdds(src.header, dst.header());
...
inline void from_fastdds(
    const carla_msgs::msg::CarlaCollisionEvent& src,
    msg::CarlaCollisionEvent& dst) {
  from_fastdds(src.header(), dst.header);
  dst.other_actor_id = src.other_actor_id();
...
inline void to_fastdds(
    const msg::CarlaEgoVehicleControl& src,
    carla_msgs::msg::CarlaEgoVehicleControl& dst) {
  to_fastdds(src.header, dst.header());
...
inline void from_fastdds(
    const carla_msgs::msg::CarlaEgoVehicleControl& src,
    msg::CarlaEgoVehicleControl& dst) {
  from_fastdds(src.header(), dst.header);
  dst.throttle = src.throttle();
  dst.steer = src.steer();
  dst.brake = src.brake();
...
// POD is CarlaLineInvasion, FastDDS class is LaneInvasionEvent
inline void to_fastdds(
    const msg::CarlaLineInvasion& src,
    carla_msgs::msg::LaneInvasionEvent& dst) {
  to_fastdds(src.header, dst.header());
  dst.crossed_lane_markings(src.crossed_lane_markings);
}

inline void from_fastdds(
    const carla_msgs::msg::LaneInvasionEvent& src,
    msg::CarlaLineInvasion& dst) {
  from_fastdds(src.header(), dst.header);
  dst.crossed_lane_markings = src.crossed_lane_markings();
}
