...
/// Type-erased abstract interface for a DDS publisher backend.
/// The concrete implementations (FastDDSPublisherBackend, CycloneDDSPublisherBackend)
/// handle all vendor-specific DDS entity creation, type registration, and data writing.
class IDDSPublisherBackend {
public:
  virtual ~IDDSPublisherBackend() = default;
