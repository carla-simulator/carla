...
std::vector<msg::PointField> CarlaRadarPublisher::GetFields() {

    msg::PointField descriptor1;
    descriptor1.name = "x";
    descriptor1.offset = 0;
    descriptor1.datatype = msg::PointField::FLOAT32;
    descriptor1.count = 1;

    msg::PointField descriptor2;
    descriptor2.name = "y";
    descriptor2.offset = 4;
    descriptor2.datatype = msg::PointField::FLOAT32;
    descriptor2.count = 1;

    msg::PointField descriptor3;
    descriptor3.name = "z";
    descriptor3.offset = 8;
    descriptor3.datatype = msg::PointField::FLOAT32;
    descriptor3.count = 1;

    msg::PointField descriptor4;
    descriptor4.name = "velocity";
    descriptor4.offset = 12;
    descriptor4.datatype = msg::PointField::FLOAT32;
    descriptor4.count = 1;

    msg::PointField descriptor5;
    descriptor5.name = "azimuth";
    descriptor5.offset = 16;
    descriptor5.datatype = msg::PointField::FLOAT32;
    descriptor5.count = 1;

    msg::PointField descriptor6;
    descriptor6.name = "altitude";
    descriptor6.offset = 20;
    descriptor6.datatype = msg::PointField::FLOAT32;
    descriptor6.count = 1;

    msg::PointField descriptor7;
    descriptor7.name = "depth";
    descriptor7.offset = 24;
    descriptor7.datatype = msg::PointField::FLOAT32;
    descriptor7.count = 1;
