...
namespace ros2 {
  ...
  bool CarlaDepthCameraPublisher::Init() {
    ...
    std::string topic_name {"rt/carla/depth_camera"};
...
void CarlaDepthCameraPublisher::SetData(size_t height, size_t width, const uint8_t* data, const char* frame_id) {
  ...
  void CarlaDepthCameraPublisher::SetData(size_t height, size_t width, std::vector<uint8_t>&& data, const char* frame_id) {
  ...
  _impl(std::make_unique<CarlaDepthCameraPublisherImpl>()) {}
