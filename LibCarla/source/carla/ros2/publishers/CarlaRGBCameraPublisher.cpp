...
namespace ros2 {
  ...
  bool CarlaRGBCameraPublisher::Init() {
    ...
    const std::string topic_name {"rt/carla/rgb_camera"};
...
void CarlaRGBCameraPublisher::SetData(size_t height, size_t width, const uint8_t* data, const char* frame_id) {
  ...
  void CarlaRGBCameraPublisher::SetData(size_t height, size_t width, std::vector<uint8_t>&& data, const char* frame_id) {
  ...
  _impl(std::make_unique<CarlaRGBCameraPublisherImpl>()) {}
