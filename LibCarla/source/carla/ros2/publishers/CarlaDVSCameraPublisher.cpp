...
namespace ros2 {
  ...
  bool CarlaDVSCameraPublisher::Init() {
    ...
    const std::string topic_name {"rt/carla/dvs_camera"};
...
void CarlaDVSCameraPublisher::SetData(size_t height, size_t width, const uint8_t* data, const char* frame_id) {
  ...
  void CarlaDVSCameraPublisher::SetData(size_t height, size_t width, std::vector<uint8_t>&& data, const char* frame_id) {
  ...
  _impl(std::make_unique<CarlaDVSCameraPublisherImpl>()) {}
