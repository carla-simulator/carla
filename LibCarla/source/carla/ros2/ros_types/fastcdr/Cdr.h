...
public:
  ...
  //! @brief This enumeration represents the two posible values of the flag that points if the content is a parameter
  //! list (only in DDS CDR).
   ...
   * @param cdrType Represents the type of CDR that will be used in serialization/deserialization. The default value is
   * CORBA CDR.
   */
  ...
  inline Cdr& operator<<(const std::vector<_T, _Alloc>& vector_t) {
   ...
   */
  template <class _T, class _Alloc>
  inline Cdr& operator>>(std::vector<_T, _Alloc>& vector_t) {
   ...
   */
  template <class _T, class _Alloc>
  Cdr& serialize(const std::vector<_T, _Alloc>& vector_t, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const uint8_t* octet_t, size_t numElements, Endianness endianness) {
    (void)endianness;
    return serializeArray(reinterpret_cast<const char*>(octet_t), numElements);
  }
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const char* char_t, size_t numElements, Endianness endianness) {
    (void)endianness;
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const int8_t* int8, size_t numElements, Endianness endianness) {
    (void)endianness;
    return serializeArray(reinterpret_cast<const char*>(int8), numElements);
  }
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const uint16_t* ushort_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const uint32_t* ulong_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const uint64_t* ulonglong_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const bool* bool_t, size_t numElements, Endianness endianness) {
    (void)endianness;
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const std::string* string_t, size_t numElements, Endianness endianness) {
    bool auxSwap = m_swapBytes;
    m_swapBytes = (m_swapBytes && (static_cast<Endianness>(m_endianness) == endianness)) ||
                  (!m_swapBytes && (static_cast<Endianness>(m_endianness) != endianness));
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& serializeArray(const std::wstring* string_t, size_t numElements, Endianness endianness) {
    bool auxSwap = m_swapBytes;
    m_swapBytes = (m_swapBytes && (static_cast<Endianness>(m_endianness) == endianness)) ||
                  (!m_swapBytes && (static_cast<Endianness>(m_endianness) != endianness));
   ...
   */
  template <class _T, class _Alloc>
  Cdr& serializeArray(const std::vector<_T, _Alloc>* vector_t, size_t numElements) {
    for (size_t count = 0; count < numElements; ++count) {
   ...
   */
  template <class _T, class _Alloc>
  Cdr& deserialize(std::vector<_T, _Alloc>& vector_t, Endianness endianness) {
    bool auxSwap = m_swapBytes;
    m_swapBytes = (m_swapBytes && (static_cast<Endianness>(m_endianness) == endianness)) ||
                  (!m_swapBytes && (static_cast<Endianness>(m_endianness) != endianness));
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(uint8_t* octet_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(uint16_t* ushort_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(uint32_t* ulong_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(uint64_t* ulonglong_t, size_t numElements, Endianness endianness) {
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(std::string* string_t, size_t numElements, Endianness endianness) {
    bool auxSwap = m_swapBytes;
    m_swapBytes = (m_swapBytes && (static_cast<Endianness>(m_endianness) == endianness)) ||
                  (!m_swapBytes && (static_cast<Endianness>(m_endianness) != endianness));
   ...
   * exceeds the internal memory size.
   */
  inline Cdr& deserializeArray(std::wstring* string_t, size_t numElements, Endianness endianness) {
    bool auxSwap = m_swapBytes;
    m_swapBytes = (m_swapBytes && (static_cast<Endianness>(m_endianness) == endianness)) ||
                  (!m_swapBytes && (static_cast<Endianness>(m_endianness) != endianness));
   ...
   */
  template <class _T, class _Alloc>
  Cdr& deserializeArray(std::vector<_T, _Alloc>* vector_t, size_t numElements) {
    for (size_t count = 0; count < numElements; ++count) {
...
private:
  ...
  /*!
   * @brief This function template detects the content type of the STD container array and serializes the array with a
  ...
  inline size_t alignment(size_t dataSize) const {
    return dataSize > m_lastDataSize ? (dataSize - ((m_currentPosition - m_alignPosition) % dataSize)) & (dataSize - 1)
                                     : 0;
  }
