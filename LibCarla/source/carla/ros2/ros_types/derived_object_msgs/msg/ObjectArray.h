...
public:
   ...
   * @param x Reference to the object derived_object_msgs::msg::ObjectArray that will be copied.
   */
  eProsima_user_DllExport ObjectArray(ObjectArray&& x);
   ...
   * @param x Reference to the object derived_object_msgs::msg::ObjectArray that will be copied.
   */
  eProsima_user_DllExport ObjectArray& operator=(ObjectArray&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const derived_object_msgs::msg::ObjectArray& data,
