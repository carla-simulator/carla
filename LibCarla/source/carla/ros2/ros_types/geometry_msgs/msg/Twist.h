...
public:
   ...
   * @param x Reference to the object geometry_msgs::msg::Twist that will be copied.
   */
  eProsima_user_DllExport Twist(Twist&& x);
   ...
   * @param x Reference to the object geometry_msgs::msg::Twist that will be copied.
   */
  eProsima_user_DllExport Twist& operator=(Twist&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const geometry_msgs::msg::Twist& data,
