...
private:
  static constexpr bool is_plain_impl() {
    return 336ULL == (detail::TwistWithCovariance_offset_of<TwistWithCovariance, detail::TwistWithCovariance_f>() +
                      sizeof(geometry_msgs::msg::geometry_msgs__TwistWithCovariance__double_array_36));
  }
};
}  // namespace msg
}  // namespace geometry_msgs
