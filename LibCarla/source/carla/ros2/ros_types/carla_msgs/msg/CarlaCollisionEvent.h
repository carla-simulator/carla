...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaCollisionEvent that will be copied.
   */
  eProsima_user_DllExport CarlaCollisionEvent(CarlaCollisionEvent&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaCollisionEvent that will be copied.
   */
  eProsima_user_DllExport CarlaCollisionEvent& operator=(CarlaCollisionEvent&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaCollisionEvent& data,
