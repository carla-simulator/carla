...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightStatus that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightStatus(CarlaTrafficLightStatus&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightStatus that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightStatus& operator=(CarlaTrafficLightStatus&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaTrafficLightStatus& data,
