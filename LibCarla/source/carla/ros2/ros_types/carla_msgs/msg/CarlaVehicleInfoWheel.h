...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleInfoWheel that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleInfoWheel(CarlaVehicleInfoWheel&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleInfoWheel that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleInfoWheel& operator=(CarlaVehicleInfoWheel&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaVehicleInfoWheel& data,
