...
public:
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl(CarlaVehicleControl&& x);
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl& operator=(CarlaVehicleControl&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const carla_msgs::msg::CarlaVehicleControl& data,
