    ...
    namespace msg {
        ...
        PointCloud2PubSubTypeT<ALLOCATOR>::PointCloud2PubSubTypeT()
        {
            ...
            size_t keyLength = PointCloud2T<ALLOCATOR>::getKeyMaxCdrSerializedSize() > 16 ?
                    PointCloud2T<ALLOCATOR>::getKeyMaxCdrSerializedSize() : 16;
        ...
        template <class ALLOCATOR>
        bool PointCloud2PubSubTypeT<ALLOCATOR>::serialize(
                void* data,
        ...
        template <class ALLOCATOR>
        bool PointCloud2PubSubTypeT<ALLOCATOR>::deserialize(
                SerializedPayload_t* payload,
                void* data)
        {
            try
        ...
        template <class ALLOCATOR>
        std::function<uint32_t()> PointCloud2PubSubTypeT<ALLOCATOR>::getSerializedSizeProvider(
                void* data)
        {
        ...
        template <class ALLOCATOR>
        void PointCloud2PubSubTypeT<ALLOCATOR>::deleteData(
                void* data)
        {
        ...
        template <class ALLOCATOR>
        bool PointCloud2PubSubTypeT<ALLOCATOR>::getKey(
                void* data,
