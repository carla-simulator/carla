...
public:
   ...
   * @param x Reference to the object shape_msgs::msg::SolidPrimitive that will be copied.
   */
  eProsima_user_DllExport SolidPrimitive(SolidPrimitive&& x);
   ...
   * @param x Reference to the object shape_msgs::msg::SolidPrimitive that will be copied.
   */
  eProsima_user_DllExport SolidPrimitive& operator=(SolidPrimitive&& x);
   ...
   */
  eProsima_user_DllExport static size_t getCdrSerializedSize(const shape_msgs::msg::SolidPrimitive& data,
