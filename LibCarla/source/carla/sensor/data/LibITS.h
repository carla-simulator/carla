...
// ETSI ITS message model (CAM, DENM containers). This header is a vendored
// transliteration of the ASN.1-generated ITS type definitions; its internal
// shape mirrors the standard and is intentionally preserved.
