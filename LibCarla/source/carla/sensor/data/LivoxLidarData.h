    ...
    namespace sensor
    {
        ...
        namespace data
        {
            ...
            public:
                ...
                LivoxLidarDetection(float x, float y, float z, float intensity) : point(x, y, z), intensity{intensity} {}
                LivoxLidarDetection(geom::Location p, float intensity) : point(p), intensity{intensity} {}
