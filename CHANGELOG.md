...
* Fixed `CarlaSetup.sh` to use the CMake 3.28.3 installed by its prerequisite step during the same setup invocation when the parent shell's CMake is too old.
