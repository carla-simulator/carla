...
class Scenario:
    def __init__(self, test):
        ...
        spectator.set_transform(
            carla.Transform(carla.Location(28.32, 130.43, 5.84), carla.Rotation(pitch=-29, yaw=180))
        )
        player_bp_to_spawn = bp_lib.find('static.prop.vendingmachine')
        self.player = self.world.try_spawn_actor(
            player_bp_to_spawn, carla.Transform(carla.Location(14.338, 130.16, 0.6), carla.Rotation(yaw=180))
        )
