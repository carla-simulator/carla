...
class TestTransform(unittest.TestCase):
    ...
    def test_print(self):
        t = carla.Transform(carla.Location(x=1.0, y=2.0, z=3.0), carla.Rotation(pitch=4.0, yaw=5.0, roll=6.0))
        s = 'Transform(Location(x=1.000000, y=2.000000, z=3.000000), Rotation(pitch=4.000000, yaw=5.000000, roll=6.000000))'
        self.assertEqual(str(t), s)

    def test_translation(self):
        error = 0.001
        t = carla.Transform(carla.Location(x=8.0, y=19.0, z=20.0), carla.Rotation(pitch=0.0, yaw=0.0, roll=0.0))
    ...
    def test_rotation(self):
        error = 0.001
        t = carla.Transform(carla.Location(x=0.0, y=0.0, z=0.0), carla.Rotation(pitch=180.0, yaw=0.0, roll=0.0))
    ...
    def test_rotation_and_translation(self):
        error = 0.001
        t = carla.Transform(carla.Location(x=0.0, y=0.0, z=-1.0), carla.Rotation(pitch=90.0, yaw=0.0, roll=0.0))
    ...
    def test_list_rotation_and_translation_vector3d(self):
        ...
        point_list = [carla.Vector3D(0.0, 0.0, 2.0), carla.Vector3D(0.0, 10.0, 1.0), carla.Vector3D(0.0, 18.0, 2.0)]
        t.transform(point_list)

        solution_list = [
            carla.Vector3D(-2.0, 0.0, -1.0),
