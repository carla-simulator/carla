...
class LocalPlanner(object):
    ...
    def set_global_plan(self, current_plan):
        ...
        current_plan.reverse()# joe: changed this to invert the waypoint trace route

        for elem in current_plan:
            self._waypoints_queue.append(elem)
        self._target_road_option = RoadOption.LANEFOLLOW
        self._global_plan = True
        #print("global=",self._waypoints_queue)
    ...
    def run_step(self, debug=False):
        ...
        if not self._global_plan and len(self._waypoints_queue) < int(self._waypoints_queue.maxlen * 0.5):
            ...
            print("computing next wwaypoint")
        ...
        #retVal=self._waypoint_buffer.reverse()
        #print("Buffer....", self._waypoint_buffer)
        #print("type...",type(self._waypoint_buffer))
        #print(".................")
        ...
        if debug:
            print("target=",self.target_waypoint)
