...
"""Allows controlling a vehicle with a keyboard, focused on fisheye cameras."""
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction,
        ...
        self.sensors = [
            ['sensor.camera.rgb_fisheye', cc.Raw, 'Fisheye Camera RGB', {}],
            ['sensor.camera.depth_fisheye', cc.Raw, 'Camera Depth (Raw, Fisheye)', {}],
            ['sensor.camera.depth_fisheye', cc.Depth, 'Camera Depth (Gray Scale, Fisheye)', {}],
            ['sensor.camera.depth_fisheye', cc.LogarithmicDepth, 'Camera Depth (Logarithmic Gray Scale, Fisheye)', {}],
            ['sensor.camera.semantic_segmentation_fisheye', cc.Raw, 'Camera Semantic Segmentation (Raw, Fisheye)', {}],
            ['sensor.camera.semantic_segmentation_fisheye', cc.CityScapesPalette, 'Camera Semantic Segmentation (CityScapes Palette, Fisheye)', {}],
            ['sensor.camera.instance_segmentation_fisheye', cc.CityScapesPalette, 'Camera Instance Segmentation (CityScapes Palette, Fisheye)', {}],
            ['sensor.camera.instance_segmentation_fisheye', cc.Raw, 'Camera Instance Segmentation (Raw, Fisheye)', {}],
