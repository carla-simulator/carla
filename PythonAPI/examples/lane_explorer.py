...
def draw_waypoint_info(debug, w, lt=5):
    ...
    debug.draw_string(w_loc + carla.Location(z=-0.5), str(w.lane_change), False, red, lt)
...
def main():
    ...
    argparser.add_argument('-x', default=0.0, type=float, help='X start position (default: 0.0)')
    argparser.add_argument('-y', default=0.0, type=float, help='Y start position (default: 0.0)')
    argparser.add_argument('-z', default=0.0, type=float, help='Z start position (default: 0.0)')
    argparser.add_argument(
        '-s', '--seed', metavar='S', default=None, type=int, help='Seed for the random path (default: None)'
    )
    argparser.add_argument(
        '-t',
        '--tick-time',
