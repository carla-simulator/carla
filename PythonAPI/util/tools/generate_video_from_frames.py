...
def argument_parser():
    ...
    argparser.add_argument('--frames', required=True, help='Folder where frames are stored')
    argparser.add_argument('--video', default='video', type=str, help='Name of the output video')
    argparser.add_argument('--fps', default=20, type=int, help='Frames per second (FPS)')
