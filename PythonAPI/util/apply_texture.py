...
def main():
    ...
    argparser.add_argument('-l', '--list', action='store_true', help='Prints names of all objects in the scene')
    argparser.add_argument('-d', '--diffuse', type=str, default='', help='Path to diffuse image to update')
    argparser.add_argument('-o', '--object-name', type=str, help='Object name')
    argparser.add_argument('-n', '--normal', type=str, default='', help='Path to normal map to update')
    argparser.add_argument(
        '--ao_roughness_metallic_emissive', type=str, default='', help='Path to normal map to update'
    )
    ...
    world.apply_textures_to_object(
        args.object_name, tex_diffuse, carla.TextureFloatColor(0, 0), tex_normal, tex_ao_r_m_e
    )
