...
def main():
    ...
    argparser.add_argument('--show', action='store_true', help='Show the spawning points in the scene')
    ...
    if args.show:
        ...
        for i, spawn_point in enumerate(spawn_points):
            ...
            world.debug.draw_string(
                spawn_point.location + carla.Location(z=3), str(i), life_time=0, color=carla.Color(0, 0, 0)
            )
