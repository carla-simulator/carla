...
"""
This is a benchmarking script for CARLA's Traffic Manager.
It serves to analyze the performances in different scenarios and
conditions.
...
def run_tm_benchmark(world, sensors, n_vehicles, n_walkers, client, debug=False):
    global sensors_callback
...
def serialize_records(records, system_specs, filename):
    ...
    with open(filename, 'w+') as fd:
        s = "| Town | Sensors |# of Vehicles | # of Walkers | Samples | Mean FPS | Std FPS |\n"
        s += "| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |\n"
        fd.write(s)
    ...
    for town in sorted(maps):
      ...
      for env in define_environments():
          for sensors in define_sensors():
            list_fps = run_tm_benchmark(world, sensors, env["vehicles"], env["walkers"], client)
...
if __name__ == '__main__':
    description = "Performance benchmark for CARLA's Traffic Manager in your platform for different towns and enviroment configurations\n"
