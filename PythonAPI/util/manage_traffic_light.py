...
def main():
    ...
    argparser.add_argument('--id', required=True, help='OpenDrive ID of the traffic light to control')
    argparser.add_argument('-gt', '--green-time', default=-1, type=int, help='Sets the green time of the traffic light')
    argparser.add_argument(
        '-yt', '--yellow-time', default=-1, type=int, help='Sets the yellow time of show the traffic light'
    )
    argparser.add_argument('-rt', '--red-time', default=-1, type=int, help='Sets the red time of the traffic light')
    argparser.add_argument('-st', '--state', default='NONE', help='Sets the state time of the traffic light')
    argparser.add_argument('-f', '--freeze', action='store_true', help='Freezes the traffic light')
    argparser.add_argument('-rg', '--reset-group', action='store_true', help="Resets the traffic light's group")
