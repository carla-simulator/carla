    ...
    for junction in junctions:
        ...
        for entry_wp, exit_wp in wps:
            world.debug.draw_arrow(
                entry_wp.transform.location + carla.Location(z=offset),
                exit_wp.transform.location + carla.Location(z=offset),
                life_time=args.show,
                arrow_size=0.5,
                thickness=0.1,
        ...
        for tl in tls:
            ...
            world.debug.draw_arrow(
                text_location + carla.Location(z=offset),
                tl_location + carla.Location(z=offset),
                life_time=args.show,
                arrow_size=0.5,
                thickness=0.1,
