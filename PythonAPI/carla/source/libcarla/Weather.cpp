...
void export_weather() {
  ...
  cls.attr("HardRainyNoon") = cr::WeatherParameters::HardRainyNoon;
  cls.attr("SoftRainyNoon") = cr::WeatherParameters::SoftRainyNoon;
  ...
  cls.attr("MidRainySunset") = cr::WeatherParameters::MidRainySunset;
  cls.attr("HardRainySunset") = cr::WeatherParameters::HardRainySunset;
  cls.attr("SoftRainySunset") = cr::WeatherParameters::SoftRainySunset;
  ...
  cls.attr("SoftRainyNight") = cr::WeatherParameters::SoftRainyNight;
  cls.attr("MidRainyNight") = cr::WeatherParameters::MidRainyNight;
  cls.attr("HardRainyNight") = cr::WeatherParameters::HardRainyNight;
