...
void export_actor() {
  ...
  // work-around, force return copy to resolve Actor instead of ActorState.
      ...
      .def("get_bone_world_transforms", &cc::Actor::GetBoneWorldTransforms)
      .def("get_bone_relative_transforms", &&cc::Actor::GetBoneRelativeTransforms)
      .def("get_component_names", &&cc::Actor::GetComponentNames)
      .def("get_bone_names", &&cc::Actor::GetBoneNames)
