...
#include <carla/sensor/data/LivoxLidarMeasurement.h> // livox
...
namespace carla
{
  namespace sensor
  {
    namespace data
    {
      ...
      std::ostream &operator<<(std::ostream &out, const LivoxLidarDetection &det)
      {
        out << "LivoxLidarDetection(x=" << std::to_string(det.point.x)
            << ", y=" << std::to_string(det.point.y)
            << ", z=" << std::to_string(det.point.z)
            << ", intensity=" << std::to_string(det.intensity)
            << ')';
...
void export_sensor_data()
{
  ...
  class_<csd::Image, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::Image>>("Image", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::Image &self, size_t pos) -> csd::Color
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::Image &self, size_t pos, csd::Color color)
                         { self.at(pos) = color; })
  ...
  class_<csd::OpticalFlowImage, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::OpticalFlowImage>>("OpticalFlowImage", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::OpticalFlowImage &self, size_t pos) -> csd::OpticalFlowPixel
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::OpticalFlowImage &self, size_t pos, csd::OpticalFlowPixel color)
                         { self.at(pos) = color; })
      .def(self_ns::str(self_ns::self));
  ...
  class_<csd::LidarMeasurement, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::LidarMeasurement>>("LidarMeasurement", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::LidarMeasurement &self, size_t pos) -> csd::LidarDetection
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::LidarMeasurement &self, size_t pos, const csd::LidarDetection &detection)
  ...
  class_<csd::LivoxLidarMeasurement, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::LivoxLidarMeasurement>>("LivoxLidarMeasurement", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::LivoxLidarMeasurement &self, size_t pos) -> csd::LivoxLidarDetection
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::LivoxLidarMeasurement &self, size_t pos, const csd::LivoxLidarDetection &detection)
                         { self.at(pos) = detection; })
      .def(self_ns::str(self_ns::self));
  ...
  class_<csd::SemanticLidarMeasurement, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::SemanticLidarMeasurement>>("SemanticLidarMeasurement", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::SemanticLidarMeasurement &self, size_t pos) -> csd::SemanticLidarDetection
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::SemanticLidarMeasurement &self, size_t pos, const csd::SemanticLidarDetection &detection)
                         { self.at(pos) = detection; })
      .def(self_ns::str(self_ns::self));
  ...
  class_<csd::RadarMeasurement, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::RadarMeasurement>>("RadarMeasurement", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::RadarMeasurement &self, size_t pos) -> csd::RadarDetection
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::RadarMeasurement &self, size_t pos, const csd::RadarDetection &detection)
                         { self.at(pos) = detection; })
      .def(self_ns::str(self_ns::self));
  ...
  class_<csd::LivoxLidarDetection>("LivoxLidarDetection")
      .def_readwrite("point", &csd::LivoxLidarDetection::point)
  ...
  class_<csd::DVSEventArray, bases<cs::SensorData>, boost::noncopyable, boost::shared_ptr<csd::DVSEventArray>>("DVSEventArray", no_init)
      ...
      .def(
          "__getitem__", +[](const csd::DVSEventArray &self, size_t pos) -> csd::DVSEvent
          { return self.at(pos); })
      .def(
          "__setitem__", +[](csd::DVSEventArray &self, size_t pos, csd::DVSEvent event)
                         { self.at(pos) = event; })
