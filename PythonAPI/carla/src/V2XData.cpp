...
void export_v2x() {
  ...
  class_<csd::CAMEvent, bases<cs::SensorData>, boost::noncopyable, std::shared_ptr<csd::CAMEvent>>("CAMEvent", no_init)
  ...
  class_<csd::CustomV2XEvent, bases<cs::SensorData>, boost::noncopyable, std::shared_ptr<csd::CustomV2XEvent>>("CustomV2XEvent", no_init)
