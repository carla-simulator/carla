...
class VehiclePIDController():
    ...
    def __init__(self, vehicle, args_lateral=None, args_longitudinal=None):
        ...
        :param args_lateral: dictionary of arguments to set the
            lateral PID controller using the following semantics:
                             K_P -- Proportional term
                             K_D -- Differential term
                             K_I -- Integral term
        :param args_longitudinal: dictionary of arguments to set the
            longitudinal PID controller using the following
