...
class GlobalRoutePlanner(object):
    ...
    def setup(self):
        ...
        #print("graph= ", list(graph.nodes(data=True)))
    ...
    def _build_graph(self):
        ...
        for segment in self._topology:
            ...
            #print("road id and section id", road_id, section_id, lane_id)
        ...
        #nt("graph= ", list(graph.nodes(data=True)))
        #nx.draw(id_map)
        #plt.show()
        #print("map xyz to nodes=",id_map)
        #print("road id to edges=", road_id_to_edge)
    ...
    def trace_route(self, destination, origin):
        """
        ...
        for i in range(len(route) - 1):
            ...
            #draw_waypoints(self.vehicle.get_world(), current_waypoint, self.vehicle.get_location().z + 1.0)
